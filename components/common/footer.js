...
const Footer = () => {
    return (
        <div>
            <footer className=" black text-third m-2 border border-third rounded-xl ">
                <div className="max-w-screen-xl px-4 py-16 mx-auto sm:px-6 lg:px-8">
                    <h1 className="text-second mb-8">Green Apparels</h1>
                    <div className="lg:flex lg:items-start lg:gap-8">
                        <div className="grid grid-cols-2 lg:grid-cols-5   gap-8 mt-8 lg:mt-0 lg:gap-y-16">
                            ...
                            <div className="col-span-1">
                                ...
                                <h3 className="font-medium text-second">
                                    Company
                                </h3>
                            ...
                            <ul className="col-span-1 flex justify-start col-span-2 gap-6 lg:col-span-5 ">
                                <li>
                                    <a
                                        href="/"
                                        rel="noreferrer"
                    ...
                    <div className="pt-8 mt-8 border-t border-gray-100 dark:border-gray-800">
                        <div className="grid grid-cols-1 gap-8 lg:grid-cols-2">
                            <p className="text-xs text-left  dark:text-gray-400">
                                &copy; 2023. <span className={'font-bold text-xl'}>Green Apparenls </span> All rights
                                reserved.
                            </p>
