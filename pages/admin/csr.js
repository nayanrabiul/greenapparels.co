...
const FactoriesSlide = () => {

    const [slides, getSlides] = useFetch(featchData, {page: 'csr'});
    ...
    const onFinish = async (values) => {
        ...
        const payload = {page: 'csr', content: [...slides.content, values]}
    ...
    const deleteHandle = async (i) => {
        ...
        const payload = {page: 'csr', content: thisArray}
