...
const data = [
    {
    CompanyName: "RONG RUI GARMENT BD LTD", Tagline: "A WORLD-CLASS GARMENT FACTORY IN BANGLADESH", SpaceAllocation: {
        Cutting: "12,500 SQFT",
        Sewing: "40,000 SQFT",
    ...
    CompanyName: "Milina Fashion Co.", Tagline: "Leading Fashion Manufacturer in Bangladesh", SpaceAllocation: {
        ...
        Certification: ["OCS", "SEDEX", "ACCORD"]
...
const FactoryDetails = () => {
    ...
    return (<div className="w-full  bg-[#001201] py-8 md:py-16 lg:py-24" id={'Affiliations'}>
        <h1 className="text-center text-first pb-4 ">Our Manufactureing Units</h1>
        <div className="container text-white pb-8 ">
            ...
            <div className={'flex justify-center items-center'}>
                {width > 700 ? (
                    <Tabs
                        centered
                        defaultActiveKey="1"
                        className="text-second w-full text-second "
                        ...
                        items={data.map((gar, index) => {
                            ...
                            return {
                                ...
                                key: index,
                                children: <GarmentsDetails gar={gar} cross={false} image={false}/>,
                            };
                        })}
                    />
                ) : (
                        ...
                        {   data.map((gar, index) => (
                            <div key={index} className={'flex flex-col justify-center items-center space-y-2 '}>
                                ...
                                >
                                    ...
                                    <GarmentsDetails gar={gar} onClose={onClose} cross={true} image={false}/> ,
