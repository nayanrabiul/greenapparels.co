...
const FormInput = ({name, label, className, type = 'text', required = false, initialValue= '', rules = [], dependencies= [], isEmail, readOnly, onChange, placeholder, textArea = false, style, disabledDate, autoComplete, extra, disableInput=false, max=''}) => {
